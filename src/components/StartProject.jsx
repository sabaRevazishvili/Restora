...
import { Button, Input, SectionHeader, ScrollReveal } from './ui';
      ...
      <div className="container mx-auto px-6 md:px-12">
        <ScrollReveal>
          <SectionHeader 
            ...
            subtitle="Briefly describe your goals below and our team will get in touch to schedule a private discovery session."
          />
        </ScrollReveal>
          ...
          {startProjectFields.map((field, idx) => (
            <ScrollReveal key={field.name} delay={field.delay} threshold={0.1}>
              <Input 
                ...
                name={field.name}
                type={field.type}
                placeholder={field.type === 'select' ? 'Select a project type' : field.placeholder}
